...
#ifndef XLA_PYTHON_DLPACK_TYPES_BASE_H_
#define XLA_PYTHON_DLPACK_TYPES_BASE_H_

// Python.h must be included before nanobind headers.
#include <Python.h>
...
#endif  // XLA_PYTHON_DLPACK_TYPES_BASE_H_
